...
/** @walnut_method
 * name: iOS Click Action
 * description: Click the linked element on the iOS device
 * actionType: custom_ios_click_action
 * context: ios
 * needsLocator: true
 * category: iOS Device
 */
export async function iosClickAction(ctx: WalnutIosContext) {
  ...
  ctx.log('ios_click_action: tapped "' + ctx.locator + '"');
}
